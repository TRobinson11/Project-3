            ...
            d3.json('StHimark.geojson', function (json) {
                ...
                d3.csv('StaticSensorLocationsreid.csv', function (staticSensorLocations) {
                   ...
                   */
                    ...
                    let ssIdToAvgReadingValue = {
                        1: 15.125549966434347,
                        4: 15.152774751730574,
                        6: 15.176220977337351,
                        9: 17.103276927706474,
                        11: 15.835089353920546,
                        12: 17.770965531609406,
                        13: 15.502448170096478,
                        14: 15.122808525660401,
                        15: 14.964108111178424
                    };
...
updateStatic('StaticSensorReadingsreid.csv');
//updateMobile();
